...
adrien.hacer_depósito(100).hacer_depósito(100).hacer_depósito(200).hacer_retiro(95).mostrar_balance_usuario()

nibbles.hacer_depósito(1000).hacer_depósito(1000).hacer_retiro(400).hacer_retiro(400).mostrar_balance_usuario()

benny.hacer_depósito(1000).hacer_retiro(4000).hacer_retiro(4000).hacer_retiro(500).mostrar_balance_usuario()

nibbles.transferir_dinero(adrien,400).mostrar_balance_usuario()
adrien.mostrar_balance_usuario()